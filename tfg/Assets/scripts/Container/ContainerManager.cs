...
public class ContainerManager : MonoBehaviour
{
    ...
    public void StartDrag(Item item){
        ...
        else if (item.container is Equipamiento) {
            Equipamiento equip = item.container.gameObject.GetComponent<Equipamiento>();
            Eventmanager.OnEquipRemoved(itemMov, equip.place); }
